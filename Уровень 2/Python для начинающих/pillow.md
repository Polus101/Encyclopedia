...
![sample_text](https://github.com/Polus101/Encyclopedia/blob/master/Python для начинающих/img/pillow_1.png)
...
![sample_text](https://github.com/Polus101/Encyclopedia/blob/master/Python для начинающих/img/pillow_2.png)
...
![sample_text](https://github.com/Polus101/Encyclopedia/blob/master/Python для начинающих/img/pillow_3.png)
...
![sample_text](https://github.com/Polus101/Encyclopedia/blob/master/Python для начинающих/img/pillow_4.png)
...
<img src="https://github.com/Polus101/Encyclopedia/blob/master/Python для начинающих/img/pillow_5.gif" style="max-width:30%;max-height:50%;">

Метод `thumbnail` **сохраняет пропорции**:

<img src="https://github.com/Polus101/Encyclopedia/blob/master/Python для начинающих/img/pillow_6.gif" style="max-width:30%;max-height:50%;">
...
![sample_text](https://github.com/Polus101/Encyclopedia/blob/master/Python для начинающих/img/pillow_7.png)
