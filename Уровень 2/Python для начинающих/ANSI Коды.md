...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/ansi_1.png)
...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/ansi_2.png)
...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/ansi_3.png)
...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/ansi_colors.png)
...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/ansi_all_colors.png)
...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/ansi_all_bgg.png)

## Навигация курсора
Курсор – это вот эта “мигающая палочка”, откуда набирается текст:

![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/coursor.gif)
...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/coursor.png)
...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/ansi_jumps.png)
...
![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/print.png)

Каждый новый принт выводит строку, потом ставит перенос строки. Если выводить нечего, он выводит только перенос строки.

Это можно отключить:

![alt-текст](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%202/Python%20для%20начинающих/img/disable_print.png)
