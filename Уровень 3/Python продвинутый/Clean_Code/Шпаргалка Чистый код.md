...
1. [Названия переменных](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%203/Clean_Code/Шпаргалка%20Чистый%20код.md#названия-переменных)
2. [Отступы в коде](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%203/Clean_Code/Шпаргалка%20Чистый%20код.md#отступы-в-коде)
3. [Разбиение кода на функции](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%203/Clean_Code/Шпаргалка%20Чистый%20код.md#разбиение-кода-на-функции)
4. [Правильное написание функций](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%203/Clean_Code/Шпаргалка%20Чистый%20код.md#правильное-написание-функций)
5. [Форматирование кода](https://github.com/Polus101/Encyclopedia/blob/master/Уровень%203/Clean_Code/Шпаргалка%20Чистый%20код.md#форматирование-кода)
